...
const TextField = props => {
  ...
  return <FieldContext.Provider value={context}>
      <View style={[margins, containerStyle]}>
        ...
        {validationMessagePosition === ValidationMessagePosition.TOP && <ValidationMessage enableErrors={enableErrors} validate={others.validate} validationMessage={validationMessage} validationMessageStyle={validationMessageStyle} />}
        ...
        <View row spread>
          {validationMessagePosition === ValidationMessagePosition.BOTTOM && <ValidationMessage enableErrors={enableErrors} validate={others.validate} validationMessage={validationMessage} validationMessageStyle={validationMessageStyle} retainSpace />}
...
TextField.propTypes = {
  ...
  /**
       ...
       */
  preset: _pt.oneOfType([_pt.oneOf(['default']), _pt.oneOf([null])])
};
