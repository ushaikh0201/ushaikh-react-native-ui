...
var TextInputKeyboardManager_android_1 = __importDefault(require("../TextInputKeyboardManager/TextInputKeyboardManager.android"));
...
var CustomKeyboardViewNativeAndroid = react_native_1.requireNativeComponent('CustomKeyboardViewNativeTemp');
var CustomKeyboardView = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(prevProps.component !== component && !component)) return [3 /*break*/, 2];
                        return [4 /*yield*/, TextInputKeyboardManager_android_1.default.reset()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    CustomKeyboardView.prototype.render = function () {
        var _a = this.props, component = _a.component, initialProps = _a.initialProps;
        var KeyboardComponent = component && KeyboardRegistry_1.default.getKeyboard(component);
